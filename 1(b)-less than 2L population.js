...
const countries = [
  ...
  // less than 2 lakhs population
let lesspopulation = countries.filter(countries=>countries.population < 200000);
for (let index in lesspopulation)
console.log(lesspopulation[index].name)
